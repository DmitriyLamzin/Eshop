...
public class DaoLoggingAspect {
    ...
    @Before("execution(* org.lamzin.eshop.dao.catalog.impl.*.*(..))")
    ...
    @AfterReturning(value = "execution(* org.lamzin.eshop.dao.catalog.impl.*.*(..))",
            returning = "retVal")
    ...
    @AfterThrowing(value = "execution(* org.lamzin.eshop.dao.catalog.impl.*.*(..))", throwing = "throwable")
